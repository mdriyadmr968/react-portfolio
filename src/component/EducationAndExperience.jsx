...
const EducationAndExperience = () => {
  return (
    <section className="py-16 md:py-24 w-[90%] md:w-[80%] mx-auto">
                    ...
                    <div className="space-y-5 text-left  md:text-right ">
                      ...
                      <div className="mt-7">
                        <div className="flex flex-col justify-end gap-4 lg:flex-row lg:items-center lg:gap-12">
                          <span className="font-semibold text-[#ffc41f]">
                            2010 - 2012
                          </span>
                  ...
                  <div className="w-full md:w-1/2 pl-7 rtl:pr-7 md:pl-8 rtl:md:pr-8 lg:pl-14 rtl:lg:pr-14">
                    <div className="space-y-5 text-left rtl:text-right">
                      ...
                      <div className="mt-7">
                        ...
                        <p className="mt-5 text-gray">
                          Collaboration with visual designers: Working closely
                          with visual designers to ensure that UI design
                          elements align with the overall visual aesthetics and
                          brand guidelines.
                        </p>
                        <p className="mt-6 font-semibold">
                          3336 Southern Street Mineola, NY 11501
                        </p>
                        <div className="flex flex-wrap items-center gap-5 mt-7">
                          <div className="flex items-center justify-center border-2 rounded-full h-14 w-14 border-gray/10 backdrop-blur-2xl bg-gradient-liner from-gray/10 to-transparent">
                            <img
                              alt=""
                              loading="lazy"
                              width={24}
                  ...
                  <div className="w-full md:w-1/2 pl-7 rtl:pr-7 md:pr-8 rtl:md:pl-8 lg:pr-14 rtl:lg:pl-14">
                    <div className="space-y-5 text-left rtl:text-right md:text-right rtl:md:text-left">
                      ...
                      <div className="mt-7">
                        ...
                        <p className="mt-5 text-gray">
                          Interaction design: Defining and designing user
                          interactions, micro interactions, animations, and
                          transitions to enhance the usability and
                          delightfulness of the product.
                        </p>
                        <p className="mt-6 font-semibold">
                          1519 White Oak Drive Kansas City, MO 64127
                        </p>
                  ...
                  <div className="w-full md:w-1/2 pl-7 rtl:pr-7 md:pl-8 rtl:md:pr-8 lg:pl-14 rtl:lg:pr-14">
                    <div className="space-y-5 text-left rtl:text-right">
                      ...
                      <div className="mt-7">
                        ...
                        <p className="mt-5 text-gray">
                          Developing the visual style and aesthetic elements of
                          the interface, including color schemes, typography,
                          icons, and imagery. This involves creating a
                          consistent and visually pleasing design language that
                          aligns with the brand.
                        </p>
                        <p className="mt-6 font-semibold">
                          1466 Southern AvenueKanawha, IA 50447
                        </p>
                        <div className="flex flex-wrap items-center gap-5 mt-7">
                          <div className="flex items-center justify-center border-2 rounded-full h-14 w-14 border-gray/10 backdrop-blur-2xl bg-gradient-liner from-gray/10 to-transparent">
                            <img
